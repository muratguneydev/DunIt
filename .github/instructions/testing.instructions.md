...
# NUnit / AutoFixture Testing Conventions
...
```csharp
[Test, AutoMoqData]
public void ShouldReturnChore_WhenChoreExists(
...
Use Shouldly: `ShouldBe`, `ShouldNotBeNull`, `ShouldContain`, etc. Do not use `Assert.That`.
